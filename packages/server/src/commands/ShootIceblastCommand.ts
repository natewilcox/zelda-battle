...
/**
 * Command to shoot ice blast
 */
export class ShootIceblastCommand extends Command<BattleRoyaleRoom, Payload> {

    private MAGIC_COST = 5;

    /**
     * Executes command to shoot ice blast
     * 
     * @param param0 
     */
    execute({client, t, d, x, y}) {
        ...
        this.room.broadcast(ServerMessages.IceblastShot, {
            who: player.id,
            text: t,
            dir: d,
            x: x,
