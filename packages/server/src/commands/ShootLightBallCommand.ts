...
/**
 * Command to shoot light ball
 */
export class ShootLightBallCommand extends Command<BattleRoyaleRoom, Payload> {

    private MAGIC_COST = 10;

    /**
     * Executes command to shoot light ball
     * 
     * @param param0 
     */
    execute({client, t, d, x, y}) {
        ...
        this.room.broadcast(ServerMessages.LightBallShot, {
            who: player.id,
            text: t,
            dir: d,
            x: x,
